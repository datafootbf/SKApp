    ...
    threshold_dict = {
        'psv99_top5': {
            ...
            'Defensive Midfielder': [
                {'min': 30.22, 'max': None, 'score': 7},
                {'min': 29.48, 'max': 30.22, 'score': 5},
                {'min': 28.94, 'max': 29.48, 'score': 3},
                {'min': 28.14, 'max': 28.94, 'score': 1},
                {'min': None,  'max': 28.14, 'score': 0},
            ],
            'Central Midfielder': [
                {'min': 30.64, 'max': None, 'score': 10},
                {'min': 30.12, 'max': 30.64, 'score': 7},
                {'min': 29.6,  'max': 30.12, 'score': 5},
                {'min': 28.96, 'max': 29.6,  'score': 3},
                {'min': None,  'max': 28.96, 'score': 0},
            ],
            'Attacking Midfielder': [
                {'min': 31.02, 'max': None, 'score': 7},
                {'min': 30.14, 'max': 31.02, 'score': 5},
                {'min': 29.72, 'max': 30.14, 'score': 3},
                {'min': 28.98, 'max': 29.72, 'score': 1},
                {'min': None,  'max': 28.98, 'score': 0},
            ],
            'Winger': [
        ...
        'hi_distance_full_all_p90': {
            ...
            'Defensive Midfielder': [
                {'min': 751.09, 'max': None, 'score': 4},
                {'min': 667.8,  'max': 751.09, 'score': 3},
                {'min': 595.88, 'max': 667.8,  'score': 2},
                {'min': 523.41, 'max': 595.88, 'score': 1},
                {'min': None,   'max': 523.41, 'score': 0},
            ],
            'Central Midfielder': [
                {'min': 854.87, 'max': None, 'score': 4},
                {'min': 750.69, 'max': 854.87, 'score': 3},
                {'min': 670.84, 'max': 750.69, 'score': 2},
                {'min': 579.88, 'max': 670.84, 'score': 1},
                {'min': None,   'max': 579.88, 'score': 0},
            ],
            'Attacking Midfielder': [
                {'min': 957.92, 'max': None, 'score': 4},
                {'min': 852.48, 'max': 957.92, 'score': 3},
                {'min': 780.29, 'max': 852.48, 'score': 2},
                {'min': 671.45, 'max': 780.29, 'score': 1},
                {'min': None,   'max': 671.45, 'score': 0},
            ],
            'Winger': [
        ...
        'total_distance_full_all_p90': {
            ...
            'Defensive Midfielder': [
                {'min': 11096.29, 'max': None, 'score': 10},
                {'min': 10844.38,'max': 11096.29, 'score': 7},
                {'min': 10596.64, 'max': 10844.38,'score': 5},
                {'min': 10273.44,  'max': 10596.64, 'score': 3},
                {'min': None,    'max': 10273.44,  'score': 0},
            ],
            'Central Midfielder': [
                {'min': 11228.7,  'max': None, 'score': 10},
                {'min': 10998.45,  'max': 11228.7,  'score': 7},
                {'min': 10735.39,  'max': 10998.45,  'score': 5},
                {'min': 10483.44,   'max': 10735.39,  'score': 3},
                {'min': None,    'max': 10483.44,   'score': 0},
            ],
            'Attacking Midfielder': [
                {'min': 11155.81,  'max': None, 'score': 7},
                {'min': 10942.79,  'max': 11155.81, 'score': 5},
                {'min': 10622.4,  'max': 10942.79, 'score': 3},
                {'min': 10192.36,  'max': 10622.4, 'score': 1},
                {'min': None,    'max': 10192.36, 'score': 0},
            ],
            'Winger': [
        ...
        'hsr_distance_full_all_p90': {
            ...
            'Defensive Midfielder': [
                {'min': 623.74,  'max': None,    'score': 10},
                {'min': 568.99,  'max': 623.74,  'score': 7},
                {'min': 513.57,  'max': 568.99,  'score': 5},
                {'min': 440.13,  'max': 513.57,  'score': 3},
                {'min': None,    'max': 440.13,  'score': 0},
            ],
            'Central Midfielder': [
                {'min': 723.77,  'max': None,    'score': 7},
                {'min': 673.59,  'max': 723.77,  'score': 5},
                {'min': 628.76,  'max': 673.59,  'score': 3},
                {'min': 547.42,  'max': 628.76,  'score': 1},
                {'min': None,    'max': 547.42,  'score': 0},
            ],
            'Attacking Midfielder': [
                {'min': 725.6,  'max': None,    'score': 10},
                {'min': 681.82,  'max': 725.6,  'score': 7},
                {'min': 617.64,  'max': 681.82,  'score': 5},
                {'min': 534.71,  'max': 617.64,  'score': 3},
                {'min': None,    'max': 534.71,  'score': 0},
            ],
            'Winger': [
        ...
        'sprint_distance_full_all_p90': {
            ...
            'Defensive Midfielder': [
                {'min': 147.68, 'max': None,    'score': 4},
                {'min': 121.86, 'max': 147.68,  'score': 3},
                {'min': 99, 'max': 121.86,  'score': 2},
                {'min': 77.73,  'max': 99,  'score': 1},
                {'min': None,   'max': 77.73,   'score': 0},
            ],
            'Central Midfielder': [
                {'min': 207.39, 'max': None,    'score': 4},
                {'min': 173.48, 'max': 207.39,  'score': 3},
                {'min': 142.25, 'max': 173.48,  'score': 2},
                {'min': 102.48,  'max': 142.25,  'score': 1},
                {'min': None,   'max': 102.48,   'score': 0},
            ],
            'Attacking Midfielder': [
                {'min': 224.39, 'max': None,    'score': 4},
                {'min': 184.81, 'max': 224.39,  'score': 3},
                {'min': 163.47, 'max': 184.81,  'score': 2},
                {'min': 114.93, 'max': 163.47,  'score': 1},
                {'min': None,   'max': 114.93,  'score': 0},
            ],
            'Winger': [
        ...
        'sprint_count_full_all_p90': {
            ...
            'Defensive Midfielder': [
                {'min': 8.28,  'max': None,   'score': 4},
                {'min': 6.82,  'max': 8.28,   'score': 3},
                {'min': 5.75,  'max': 6.82,   'score': 2},
                {'min': 4.56,  'max': 5.75,   'score': 1},
                {'min': None,  'max': 4.56,   'score': 0},
            ],
            'Central Midfielder': [
                {'min': 11.76, 'max': None,   'score': 4},
                {'min': 9.94,  'max': 11.76,  'score': 3},
                {'min': 8.44,  'max': 9.94,   'score': 2},
                {'min': 6.08,  'max': 8.44,   'score': 1},
                {'min': None,  'max': 6.08,   'score': 0},
            ],
            'Attacking Midfielder': [
                {'min': 12.89, 'max': None,   'score': 4},
                {'min': 10.81, 'max': 12.89,  'score': 3},
                {'min': 9.13,  'max': 10.81,  'score': 2},
                {'min': 7.06,  'max': 9.13,   'score': 1},
                {'min': None,  'max': 7.06,   'score': 0},
            ],
            'Winger': [
        ...
        'highaccel_count_full_all_p90': {
            ...
            'Defensive Midfielder': [
                {'min': 4.97,'max': None,'score': 10},
                {'min': 4.32,'max': 4.97,'score': 7},
                {'min': 3.81,'max': 4.32,'score': 5},
                {'min': 3.25,'max': 3.81,'score': 3},
                {'min': None,'max': 3.25,'score': 0},
            ],
            'Central Midfielder': [
                {'min': 5.68,'max': None,'score': 7},
                {'min': 4.89,'max': 5.68,'score': 5},
                {'min': 4.31,'max': 4.89,'score': 3},
                {'min': 3.65,'max': 4.31,'score': 1},
                {'min': None,'max': 3.65,'score': 0},
            ],
            'Attacking Midfielder': [
                {'min': 7.10,'max': None,'score': 7},
                {'min': 6.25,'max': 7.10,'score': 5},
                {'min': 5.60,'max': 6.25,'score': 3},
                {'min': 4.56,'max': 5.60,'score': 1},
                {'min': None,'max': 4.56,'score': 0},
            ],
            'Winger': [
